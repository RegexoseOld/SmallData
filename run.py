...
if args.app == 'backend':
    ...
    audience_client = udp_client.SimpleUDPClient(settings.ip, settings.PROCESSING_PORT)
    ...
    song_server = SongServer(oscul_client, audience_client, machine_instance, beat_manager, tonality)
