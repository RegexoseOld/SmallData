...
utts =[] # list with all the Text Objects
incomingText = '' # a mock for incoming OSC text
messageLock = False # turns true if incomingText matches an utt chosen in ScaledRotated.draw()
shapemapping = {}
